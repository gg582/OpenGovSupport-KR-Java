...
> = {
  "earned-income-deduction": {
    ...
    inputs: [
      ...
      p("donation", "기부금"),
      p("childCount", "자녀수"),
      p("sportsExpense", "체육이용료"),
      p("isMarriedInPeriod", "혼인해당"),
      p("claimedBefore", "이전수령"),
      p("spouseClaim", "배우자공제"),
    ],
    outputs: [p("earnedDeduction", "근로소득공제액"), p("totalCredits", "세액공제합계")],
    legalBasis: "「소득세법」 제47조·제59조의2~4",
    inputMap: {
  ...
  "education-credit": {
    ...
    inputs: [p("stage", "교육단계"), p("educationExpense", "교육비")],
    outputs: [p("amount", "공제액")],
    legalBasis: "「소득세법」 제59조의4 ②",
    inputMap: { stage: "stage", educationExpense: "educationExpense" },
    parent: "세액공제",
  },
  "marriage-credit": {
    label: "결혼 세액공제",
