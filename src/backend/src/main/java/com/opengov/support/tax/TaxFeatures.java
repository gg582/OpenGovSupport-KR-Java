...
/**
 * 개인세무 섹션의 Feature 매니페스트.
 *
 * <p>각 항목은 {@code resources/tax-rules/{year}/{ruleId}.json} 의 룰과 1:1 대응되며,
 * Feature {@code id}의 두 번째 세그먼트가 {@code rule_id} 가 된다.
 * (예: id={@code tax/medical-expense-credit} → 룰 {@code medical-expense-credit})
 *
 * <p>UI는 도메인키로 묶이므로 {@code 종합소득세 / 근로소득 / 특별세액공제 ...} 와 같이
 * 「소득세법」목차에 따라 그룹핑한다.
 */
public final class TaxFeatures {
    ...
    public static List<Feature> all() {
        ...
        return List.of(
                // ── 11 종합소득세 ──
                new Feature(
                        "tax/comprehensive-income-tax", s,
                        "11_종합소득세", "종합소득세",
                        "산출세액 (누진세율)",
                ...
                new Feature(
                        "tax/comprehensive-income-refund", s,
                        "11_종합소득세", "종합소득세",
                        "환급/추징 시뮬레이터",
